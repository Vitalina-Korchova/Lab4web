export class Modal {
  ...
  static showErrorModal(): void {
    ...
    const closeButtonFail = document.getElementById(
      "btn_close_modal_fail",
    ) as HTMLElement;
  ...
  static showSuccessModal(): void {
    const modalSuccess = document.getElementById(
      "modalBorrowSuccess",
    ) as HTMLElement;
    modalSuccess.style.display = "block";

    const closeButtonSuccess = document.getElementById(
      "btn_close_modal_success",
    ) as HTMLElement;
